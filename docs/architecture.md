...
- `node catalog` split into two meanings:
  ...
  `filtered`: discoverable candidates intentionally excluded before probing, such as internal, legacy, output-only, placeholder, or not-yet-validated non-`*Node` shapes
