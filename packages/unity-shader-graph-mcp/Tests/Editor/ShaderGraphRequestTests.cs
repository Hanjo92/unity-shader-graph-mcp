...
namespace ShaderGraphMcp.Editor.Tests
{
    public sealed class ShaderGraphRequestTests
    {
        ...
        [Test]
        public void DuplicateSubGraphRequest_ResolvesTargetAssetPath()
        {
            var request = new DuplicateSubGraphRequest(
                "Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph",
                "CopiedSubGraph");

            Assert.That(request.AssetPath, Is.EqualTo("Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph"));
            Assert.That(request.Name, Is.EqualTo("CopiedSubGraph"));
            Assert.That(request.TargetAssetPath, Is.EqualTo("Assets/ShaderSubGraphs/CopiedSubGraph.shadersubgraph"));
            Assert.That(request.Action, Is.EqualTo(ShaderGraphAction.DuplicateSubGraph));
        }
        ...
        [Test]
        public void DeleteSubGraphRequest_PreservesAssetPath()
        {
            var request = new DeleteSubGraphRequest("Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph");

            Assert.That(request.AssetPath, Is.EqualTo("Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph"));
            Assert.That(request.Action, Is.EqualTo(ShaderGraphAction.DeleteSubGraph));
        }
        ...
        [Test]
        public void MoveSubGraphRequest_ResolvesTargetAssetPath()
        {
            var request = new MoveSubGraphRequest(
                "Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph",
                "Assets/ShaderSubGraphs/Moved");

            Assert.That(request.AssetPath, Is.EqualTo("Assets/ShaderSubGraphs/ExampleSubGraph.shadersubgraph"));
            Assert.That(request.Action, Is.EqualTo(ShaderGraphAction.MoveSubGraph));
            Assert.That(request.TargetAssetPath, Is.EqualTo("Assets/ShaderSubGraphs/Moved/ExampleSubGraph.shadersubgraph"));
        }
    }
}
