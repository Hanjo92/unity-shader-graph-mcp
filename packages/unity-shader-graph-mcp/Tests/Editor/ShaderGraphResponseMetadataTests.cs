...
namespace ShaderGraphMcp.Editor.Tests
{
    public sealed class ShaderGraphResponseMetadataTests
    {
        ...
        [Test]
        public void Ok_PreservesVector1ToCombineConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "vector1-18",
                        ["outputPort"] = "Out",
                        ["inputNodeId"] = "combine-19",
                        ["inputPort"] = "R",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
        ...
        [Test]
        public void Ok_PreservesVector1ToVector2ConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "vector1-20",
                        ["outputPort"] = "Out",
                        ["inputNodeId"] = "vector2-21",
                        ["inputPort"] = "X",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
        ...
        [Test]
        public void Ok_PreservesVector1ToVector3ConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "vector1-22",
                        ["outputPort"] = "Out",
                        ["inputNodeId"] = "vector3-23",
                        ["inputPort"] = "X",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
        ...
        [Test]
        public void Ok_PreservesVector1ToVector4ConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "vector1-24",
                        ["outputPort"] = "Out",
                        ["inputNodeId"] = "vector4-25",
                        ["inputPort"] = "X",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
        ...
        [Test]
        public void Ok_PreservesSplitToCombineConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "split-20",
                        ["outputPort"] = "R",
                        ["inputNodeId"] = "combine-21",
                        ["inputPort"] = "R",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
        ...
        [Test]
        public void Ok_PreservesSplitToVector2ConnectionEnvelope()
        {
            var response = ShaderGraphResponse.Ok(
                "connect ports ready",
                new Dictionary<string, object>
                {
                    ...
                    ["requestedConnection"] = new Dictionary<string, object>
                    {
                        ["outputNodeId"] = "split-22",
                        ["outputPort"] = "R",
                        ["inputNodeId"] = "vector2-23",
                        ["inputPort"] = "X",
                    },
                    ["resolvedConnection"] = new Dictionary<string, object>
                    {
